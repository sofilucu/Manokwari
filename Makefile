...
ACLOCAL = ${SHELL} /tmp/buildd/manokwari-0.2.1.51/missing aclocal-1.14
ALL_LINGUAS = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /tmp/buildd/manokwari-0.2.1.51/missing autoconf
AUTOHEADER = ${SHELL} /tmp/buildd/manokwari-0.2.1.51/missing autoheader
AUTOMAKE = ${SHELL} /tmp/buildd/manokwari-0.2.1.51/missing automake-1.14
AWK = mawk
BIN_PATH = 
CATALOGS = 
CATOBJEXT = .gmo
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /tmp/buildd/manokwari-0.2.1.51/missing makeinfo
MANIFEST_TOOL = :
...
XSESSIONS_PATH = 
abs_builddir = /tmp/buildd/manokwari-0.2.1.51/system
abs_srcdir = /tmp/buildd/manokwari-0.2.1.51/system
abs_top_builddir = /tmp/buildd/manokwari-0.2.1.51
abs_top_srcdir = /tmp/buildd/manokwari-0.2.1.51
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /tmp/buildd/manokwari-0.2.1.51/install-sh
